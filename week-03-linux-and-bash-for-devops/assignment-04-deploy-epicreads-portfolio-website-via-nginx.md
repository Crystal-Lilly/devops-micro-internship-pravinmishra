...
![image](./screenshots/nginx-status.jpeg)
...
![image](./screenshots/ls-la-output.jpeg)
...
![image](./screenshots/edited-footer-visible-in-nano.jpeg)
...
![image](./screenshots/nginx-config-syntax-is-okay.jpeg)

---

#### Screenshot 4 — Output of `ls /var/www/html` showing deployed website files

![image](./screenshots/ls-var-www-html-output.jpeg)
...
![image](./screenshots/curl-ifconfig.me-showing-public-ip.jpeg)

---

#### Screenshot 6 — Browser showing the live website with your Full Name and deployment details in the footer

![image](./screenshots/website-accessible-through-browser-with-my-footer-details.jpeg)
...
![image](./screenshots/systemctl-is-enabled-nginx-output.jpeg)

---

#### Screenshot 8 — Output of `curl -I http://localhost` showing 200 OK

![image](./screenshots/curl-I-localhost-output.jpeg)
...
`https://www.linkedin.com/feed/update/urn:li:ugcPost:7483603421141499905/
