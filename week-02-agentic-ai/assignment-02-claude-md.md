...
![claude's generic response before claude.md](./screenshots/claude-response-before-claude.md-file.jpeg)
...
![autogenerated claude.md in vscode](./screenshots/autogenerated-claude.md-in-vscode.jpeg)
...
![customized claude.md](./screenshots/customised-claude.md.jpeg)
![customized claude.md](./screenshots/customised-claude.md-2.jpeg)
---
...
![claude specific detailed answer after claude.md](./screenshots/Claude-response-to-question-1.jpeg)

---

#### Screenshot 5 — Claude refusing or warning against adding React because of the "No JavaScript" convention defined in CLAUDE.md

![claude warning against adding react](./screenshots/claude-response-to-question-2.jpeg)
...
![claude.md visible in my github repo](./screenshots/claude.me-file-showing-in-github-repo.jpeg)
